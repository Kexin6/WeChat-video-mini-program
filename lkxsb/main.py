...
while True:
    ...
    while True:
        ...
        if bit < 1 or bit > 8:
            print
            "\tInput not in range 1-8"
            bi = input("Bits per channel: ")
        else:
            break

    col = input("'Mono' or 'Colour': ").lower()
    ...
    while fimg:
        ...
        print
        "\tConverting " + fimg + " to " + os.path.splitext(fimg)[0] + ".mif"
        print
        "\t" + str(wid) + "px",
        try:
            print
